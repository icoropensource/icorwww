...
function EditAreaLoader(){
   ...
   t.default_settings= {
      ...
      ,font_family: "DejaVu Sans Mono, monospace"  // can be "verdana,monospace". Allow non monospace font but Firefox get smaller tabulation with non monospace fonts. IE doesn't change the tabulation width and Opera doesn't take this option into account...
...
//      ,syntax_selection_allow: "basic,brainfuck,c,coldfusion,cpp,css,html,java,js,pas,perl,php,python,ruby,robotstxt,sql,tsql,vb,xml"
      ,syntax_selection_allow: "css,html,js,python,tsql,vb,xml"
