...
function VKI_buildKeyboardInputs() {
  ...
  this.VKI_kt = "Polish Prog";  // Default keyboard layout
      ...
      for (var y = 0, keyid = "", ex; ex = elem[y++];) {
        if ((ex.nodeName == "TEXTAREA" || ex.type == "text" || ex.type == "password") && ex.className.indexOf("keyboardInput") > -1) {
          ...
          var keybut = document.createElement('img');
              keybut.src = "lib/keyboard/keyboard.png";
              keybut.alt = "Klawiaturka";
              keybut.className = "keyboardInputInitiator";
              keybut.title = "Klawiaturka";
              keybut.className = "keyboardInputInitiator";
    ...
    var tr = document.createElement('tr');
        ...
        if (layouts > 1) {
          ...
          var label = document.createElement('label');
            var checkbox = document.createElement('input');
                ...
                checkbox.title = "Zmienia stan martwych klawiszy";
                checkbox.onclick = function() {
                  self.VKI_deadkeysOn = this.checked;
                  this.nextSibling.nodeValue = " Martwe kl.: " + ((this.checked) ? "W\u0142" : "Wy\u0142");
                  self.VKI_modify("");
                  return true;
                };
              label.appendChild(checkbox);
              label.appendChild(document.createTextNode(" Martwe kl.: " + ((checkbox.checked) ? "W\u0142" : "Wy\u0142")))
      ...
      var td = document.createElement('td');
        var clearer = document.createElement('span');
            ...
            clearer.appendChild(document.createTextNode("Kasuj"));
            clearer.title = "Kasuje pole edycyjne";
        ...
        var closer = document.createElement('span');
            ...
            closer.title = "Zamknij klawiature";
