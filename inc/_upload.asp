...
'1. You can use this software to upload files for free
' if you want to upload big files, please register ScriptUtilities and Huge-ASP upload
...
Class ASPForm
  ...
  Public Property Get SizeLimit
   ...
   'Pure - ASP upload is a free script
...
End Class 'ASPForm
Const MaxLicensedLimit = 70000000
