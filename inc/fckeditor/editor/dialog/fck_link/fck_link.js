...
function OnUploadCompleted( errorNumber, fileUrl, fileName, customMsg )
{
	switch ( errorNumber )
	{
		...
		case 101 :	// Custom warning
			...
			break ;
		case 201 :
			alert( 'Plik z taka nazwa juz istnieje. Nazwa zostala zmieniona na "' + fileName + '"' ) ;
			break ;
		case 202 :
			alert( 'Niepoprawny typ pliku' ) ;
			return ;
		case 203 :
			alert( "Konieczny kontakt z administratorem - prawdopodobnie brak dostepu do zasobow." ) ;
			return ;
		default :
