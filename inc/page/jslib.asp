<script language="javascript" src="/icorlib/handlebars-v1.3.0.min.js" runat="server"></script><script language="javascript" runat="server">
/*   
...
PageUtil = {
   f1 : function(){
      var source='<h2>Your Bio</h2><p>Your name is {{firstname}} {{lastname}} and you are {{age}} years old.</p>';
      var template=Handlebars.compile(source);
      var html = template({firstname:'ff', lastname:'ff',age:'11'});
      return html;
   },
